...
import os
from lib.train.dataset.vos_base import VOSDatasetBase, VOSMeta
from lib.pytracking.evaluation import Sequence
import json
...
class YouTubeVOS(VOSDatasetBase):
    ...
    def __init__(self, root=None, version='2019', split='train', cleanup=None, all_frames=False, sequences=None,
                 multiobj=True, vis_threshold=10, image_loader=jpeg4py_loader_w_failsafe):
        """
        args:
